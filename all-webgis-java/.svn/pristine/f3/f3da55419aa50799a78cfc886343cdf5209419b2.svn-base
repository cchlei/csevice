...
<head>
    ...
    <script src="${ctx}/assets/libs/cseajs/csea$.js" id="seajsnode" main="__/js/themes_edit"></script>
    <script>
        var pageCfg = {
        		 /*专题数量*/
      ...
      <jsp:include page="/assets/top.jsp"></jsp:include>
        ...
        <div class="mainCont col3">
            <div class="inner">
                ...
                <form action="${ctx}/topic/edit" class="addsubform">
                    <table>
                        <tr>
                            <td><em>专题名称</em></td>
                        ...
                        <tr ms-controller="share_status">
                            ...
                            <td>
                                ...
                                <input type="hidden" name="shareflag" ms-duplex-number="isopen" default_value="${userTopic.shareflag}">
                                ...
                                <input type="hidden" id="jurisdict" name="jurisdict" ms-duplex-number="jurisdict" default_value="${ userTopic.jurisdict}">
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><em>专题描述</em></td>
                            <td><textarea name="description" id="describe" placeholder="请输入专题描述" >${userTopic.description}</textarea></td>
                        </tr>
                        <tr>
                            <td><em>标签颜色</em></td>
                            <td  ms-controller='s_color'>
                                ...
                                <input type="hidden" name="topiccolor" ms-duplex="topiccolor" default_value="${userTopic.topiccolor}" >
                            </td>
                        </tr>
                        <tr ms-controller="imgupload">
                            ...
                            <%-- <td class="header-img">
                               <img id="headimg" src="${ctx}/assets/images/uploader.png" class="cover_img"/>
					           <script type="text/javascript">
					                 var url = "${userTopic.coverurl}";
					                 if(url){
					               	 $("#headimg").attr("src","http://oss.trmap.cn/rs/download/"+url);
					                 }
					           </script>
                            </td> --%>
                            <td class="imgupload">
                    ...
                    <input type="hidden" name="coverurl" id="coverurl" value="${userTopic.coverurl}">
                    <input type="hidden" name="id" id="topicId" value="${userTopic.id }">
                </form>
            </div>
        </div>
    </div>
