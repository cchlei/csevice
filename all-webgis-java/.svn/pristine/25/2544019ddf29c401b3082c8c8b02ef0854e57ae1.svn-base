...
public class EncrUtil {
	 ...
	 * 路径加密key
	 */
		public static String URLKEY = "Tirain:)";
	 /** *//**
	    * 生产8位的key
	    * 
	    * @param key
...
//	       Cipher cipher = Cipher.getInstance("DES/ECB/NoPadding");
		...
		public static void main(String[] args) {
			String a ="/20150424/4d523f21-bee6-4b7a-92d4-9a543f36ca84.png";
//			String a =  Long.toString(System.currentTimeMillis())+(int)(Math.random()*10);
			System.out.println(a);
			String value = a;
			 String encode = encoderByDES(value, "key");
			 System.out.println("加密-----------"+encode);
			 String  decode = decoderByDES(encode, "key");
