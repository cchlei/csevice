...
<body>
    ...
    <h2 class="page_tit_1">企业用户信息认证</h2>


    <form action="${ctx}/entcainfo/docainfo" class="auth_info_table" method="post">
        <div class="box">
            <em class="seqno">1</em>
            <div class="bbody">
                <h3>企业信息：</h3>
                ...
                <p>
                    <em>企业名称:</em>
                    <span class="input"><input ajax_valid_errmsg="您的企业名称已经被注册过了" type="text" name="enterpriseName"/></span>
                ...
                <p>
                    <em>营业执照注册号:</em>
                    <span class="input"><input type="text" name="enterpriseId"/></span>
                    <span class="info">
...
<!--                 <p> -->
<!--                     <em>组织机构代码:</em> -->
<!--                     <span class="input"><input type="text" name="orgId"/></span> -->
<!--                     <span class="info"> -->
...
<!--                 <div style="margin-left: 60px;" id="fileList2" class="uploader-list"></div> -->
        ...
        <div class="box">
            ...
            <div class="bbody">
                ...
                <p>
                    <em>法人代表姓名:</em>
                    <span class="input"><input type="text" name="bossName"/></span>
                    <span class="info"></span>
                </p>

                <p>
                    <em>法人代表身份证号码:</em>
                    <span class="input"><input type="text" name="bossIdentifyId"/></span>
                    <span class="info">
                ...
                <p>
                    <em>证件有效期:</em>
                    <span class="input">
                    	<input type="text" name="bossIdentifyDate" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"/>
        ...
        <div class="box">
            ...
            <div class="bbody">
                <div class="bbody">
                    ...
                    <p>
                        <em>负责人姓名:</em>
                        <span class="input"><input type="text" name="managerName"/></span>
                        <span class="info"></span>
                    </p>

                    <p>
                        <em>负责人身份证号:</em>
                        <span class="input"><input type="text" name="managerIdentifyId"/></span>
                        <span class="info">
                    ...
                    <p>
                        <em>证件有效期:</em>
                        <span class="input"><input type="text" name="managerIdentifyDate" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"/>
                        	<!-- <span class="laydate-icon" onclick="laydate({elem: '#hello1'});"></span> -->
                        </span>
                        <span class="info"></span>
                    </p>
                    ...
                    <p>
                        <em>联系电话:</em>
                        <span class="input"><input type="text" name="managerPhone"/></span>
                        <span class="info"></span>
                    </p>
                </div>
            </div>
        ...
        <div>
	        <input id="u1" type="hidden" name="enterpriseAttachUrl">
	        <input id="u2" type="hidden" name="orgAttachUrl">
	        <input id="u3"  type="hidden" name="bossIdentifyUrl">
	        <input id="u4"  type="hidden" name="managerIdentifyUrl">
    	</div>
    </form>
