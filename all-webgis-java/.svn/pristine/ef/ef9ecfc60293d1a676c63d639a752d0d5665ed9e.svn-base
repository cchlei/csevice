...
<script type="text/javascript" src="${ctx }/assets/topic/js/topic.js"></script>
</head>
<body>
	<style type="text/css">
html, body {
	...
	<div id="dialog" style="display: none;">
		<form id="addfm" method="post" ,style="height: 100%">
			...
			<div class="fitem" style="margin: 20px 30px">
				<label>专题名称</label> <input name="name" class="easyui-textbox" data-options="required:true,validType:'length[0,10]'"
					style="width: 150px" />
			</div>
			<div class="fitem" style="margin: 10px 30px">
				<label>专题排序</label> <input name="sort" class="easyui-numberbox" data-options="required:true,min:1,validType:'length[0,2]'"
					style="width: 150px" />
			</div>
		</form>
	</div>
