...
<head>
    ...
    <script src="${ctx}/assets/libs/cseajs/csea$.js" id="seajsnode"  main="__/js/service_approval_sp"></script>
    <style type="text/css">
	    .navright .service_app table.servicetab td{width:15%}
	    .navright .service_app table.servicetab td:nth-of-type(2),.navright .service_app table.servicetab td:nth-of-type(3){text-decoration:none;}
    </style>
    <script>
        //已审批表单
        var service_approval_sp_ajax ="${ctx}/entapp/getapproved";
        //已审批表单详情
        var service_approval_sp_from_ajax="${ctx}/entapp/getObj";
        //暂停
        var release_stop_ajax="${ctx}/entapp/pauseApply";
      	//恢复
        var release_hf_ajax="${ctx}/entapp/restoreApply";
    </script>
</head>
<body>
<div class="navright">
    ...
    <div class="service_app">
        ...
        <div class="zhushi">注释 <img src="${ctx}/assets/images/h_n.png" alt="">表示未过期<img src="${ctx}/assets/images/h_y.png" alt="">表示已过期</div>
        <!--服务审批显示开始-->
        ...
        <div class="yddxq" ms-controller="yddxq" style="display: none;">
            <div class="ddtop">
                ...
                订单状态：<em class="bianhao">{{dic_order_status[data.isapproved]}}</em>
                审批时间：<em>{{data.approvedtime}}</em>
