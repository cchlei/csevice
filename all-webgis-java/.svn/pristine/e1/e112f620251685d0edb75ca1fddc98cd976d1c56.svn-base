 ...
 */
@Entity
@Table(name = "qtmap_enterprise_attributmeta")
public class EntAttributemeta implements Serializable {
	...
	public EntAttributemeta() {
		super();
		// TODO Auto-generated constructor stub
	}

	public EntAttributemeta(String attralias, String attrcode, String attrtype, EntLayermeta layermeta) {
		super();
		this.attralias = attralias;
		this.attrcode = attrcode;
		this.attrtype = attrtype;
