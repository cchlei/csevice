...
<head>
    ...
    <script src="${ctx}/assets/libs/cseajs/csea$.js" id="seajsnode" main="${ctx}/assets/js/theme_collect"></script>
    <script>
        var pageCfg = {
            /*专题数量*/
            ...
            /*专题数据*/
            theme_collect_list:"${ctx}/topic/attens",
    ...
    <div class="root no_top no_col_1_2">
        ...
        <div class="mainCont col3">
            <div class="inner" ms-controller="mycollect">
                <h1 class="page_name"><i class="ico_mycollect"></i>我的关注({{total}})</h1>
                <div class="main">
                    <div class="inner">
                        <div class="theme_grid type2" ms-each="collentdata">
                            ...
                            <span ms-attr-sid="el.topic.id">
                            	<div class="inner">
                                    ...
                                    <span class="img"> <a target=_parent  ms-attr-href="${ctx}/topic/topulicinfo/{{el.topic.id}}" ><img ms-attr-src="co.getThumb(el.topic.coverurl,380,368,default_img)" alt=""></a> </span>
                                    <span class="tx_block">
                                        <table>
                                            <tr>
                                                <td class="l user_el">
