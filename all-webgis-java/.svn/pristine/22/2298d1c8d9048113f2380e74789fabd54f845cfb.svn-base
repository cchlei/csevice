 ...
 */
@Entity
@Table(name = "qtmap_enterprise_basemap")
public class EntBaseMap implements Serializable {
	...
	public EntBaseMap(Double opacity, Integer z_index, Long mapId, String basemapType) {
		super();
		this.opacity = opacity;
		this.z_index = z_index;
		this.mapId = mapId;
