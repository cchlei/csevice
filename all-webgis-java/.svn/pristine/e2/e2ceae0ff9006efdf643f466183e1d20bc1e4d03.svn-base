...
(function(a) {
    a.fn.adipoli = function(b) {
        ...
        function() {
            ...
            a(this).parent().append('<div class="adipoli-after ' + a(this).attr("class") + '" style="display:block;width:' + a(this).width() + "px; height:" + a(this).height() + 'px;"><div class="adipoli-box"></div><img src="' + a(this).attr("src") + '"/></div></div>');
			a(this).parent().append('<div class="abb ' + a(this).attr("class") + '" style="display:none;width:' + a(this).width() + "px; height:" + a(this).height() + 'px;"><img src="images/zhezhao.png"/></div>');
            ...
            a(this).parent().bind("mouseleave",
            function() {
				a(this).children(".abb").hide();
                if (c.hoverEffect == "normal") {
                    ...
                    for (var s = 0; s < c.boxCols * 2; s++) {
                        ...
                        for (var u = 0; u < c.boxRows; u++) {
                            if (t >= 0 && t < c.boxCols) { (function(b, d, e, f, g) {
                                    var h = a(r[b][d]);
                                    var i = h.width();
                                    var j = h.height();
            ...
            a(this).parent().bind("mouseenter",
            function() {
                a(this).children(".adipoli-after").html("").hide();
				a(this).children(".abb").show();
