...
(function ($) {
	...
	function init( that,options ){
		...
		$input
			...
			//.on('keydown.xdsoft cut.xdsoft paste.xdsoft', function( event ){
			.on('input.xdsoft propertychange.xdsoft cut.xdsoft paste.xdsoft', function( event ){
	...
	//当输入框条件更改时调用
	$.fn.on_input_change = function(){
	    return this.each(function(i){
	        var me=$(this);
			if(me.is("on_input_change"))	return;
			me.addClass("on_input_change");
