...
<head>
    ...
    <script>
        ...
        var pageCfg = {
            ...
            /*附件图片展示*/
            imgs_data:"${ctx}/record/attachs/${record.id}",
            /*附件删除*/
...
<body>
    ...
    <div class="root no_top no_col_1_2">
        ...
        <div class="mainCont col3">
            <div class="inner">
                <h1 class="page_name white"><a href="javascript:history.go(-1)"><i class="ico_record"></i></a>编辑记录</h1>

                <form action="${ctx}/record/update" class="record_add">
                    <table>
                        <tr>
                            <td>
                                <em>标题</em>
                            ...
                            <td ms-controller="isopen">
                                ...
                                <input type="hidden" name="shareflag" ms-duplex-number="isopen" value="${record.shareflag}">
                                <script>
                                    /* if(!isPrivateTopic){
                                        $("tr:last").hide();
                                    } */
                            ...
                            <td>
                                ...
                                <input name="occurtimes" readonly="readonly" type="hidden"  value="${datestr}"/>
                                <script>
                        ...
                        <tr>
                            <td  ms-controller="linkadress" class="linkadress">
                                <em>地点</em>
                                <input type="text" id=addrname name="addrname" value="${record.addrname}">
                                <input type="hidden" name="geom" id="geom" value="${record.geom}"/>
                    ...
                    <input type="hidden" name="id" id="recordid" value="${record.id}">
                    <input type="hidden" name="topicid" id="topicid" value="${record.topic.id}">
