...
public class DruidConfiguration {
    ...
    public ServletRegistrationBean DruidStatViewServle2(){
       ...
       ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(new StatViewServlet(),"/alidruid/*");
    ...
    public FilterRegistrationBean druidStatFilter2(){
       ...
       //添加不需要忽略的格式信息.
       filterRegistrationBean.addInitParameter("exclusions","*.js,*.gif,*.jpg,*.png,*.css,*.ico,/alidruid/*");
